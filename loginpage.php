...
<form action="" form method="post">
  ...
  <div class="container">
    ...
    <input type="password" placeholder="Enter Password" name="psw"><br></br>
     <br></br>   
    <button type="submit" class="w3-button w3-white w3-border w3-border-blue w3-round-large">Login</button>
    &nbsp;
    <button type="submit" formaction="registeration.php" class="w3-button w3-white w3-border w3-border-blue w3-round-large">Register</button>
